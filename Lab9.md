...
![](Lab9_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
The Cronbach’s alpha of Scale Seeking subscale is .83, indicating that
it is a reliable measure. Since the Cronbach’s alpha is above .8,
indicating that the items have good internal consistency reliability.
...
Based on the scree plot and parallel analysis, I can identify 1 factor
from the results. The range of the factor loadings is .82-.94. FSMI51
has the highest factor loading of .94. Since all the factor loadings are
above .6, this is a good measure of break up concern.
...
The items have a Cronbach’s alpha of .89, indicating good internal
consistency for the items within the Kin Care (Family) subscale.
Therefore, we can say that the measure of Kin Care (Family) is reliable.
Based on the scree plot and parallel analysis, I can identify 1 factor
fo the Kin Care (Family) subscale, explaining 66.32% of the variance.
The range of the factor loadings is .72-.82. FSMI59 has the highest
factor loading of .82. Since all the factor loadings are above .6, this
is a good measure of kin care for family.
